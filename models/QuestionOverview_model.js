...
module.exports = function questionOverview() {
    ...
    return new Promise((resolve, reject) => {
        ...
        function(err,easyRows){
            ...
            db.query('SELECT u.id, u.name, avg(s.score) as unitAvg FROM units AS u JOIN scores AS s ON s.unit_id = u.id GROUP BY u.id having unitAvg >=60 AND unitAvg <=80 ORDER BY u.id',
